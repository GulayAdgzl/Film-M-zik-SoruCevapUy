...
public class KolayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] arrayQ = {getString (R.string.k1), getString (R.string.k2), getString (R.string.k3)
                , getString (R.string.k4), getString (R.string.k5)};
        final Boolean[] arrayA = {true, false, false, true, true};
        ...
        dogru.setOnClickListener(new View.OnClickListener() {
            ...
            private void result() {
                ...
                startActivity(new Intent(KolayActivity.this,
